...
namespace JUST.UnitTests.Issues
{
    ...
    public class OutputTests
    {
        ...
        [Test]
        public void MultipleArraysJoinArrays()
        {
            var input = "{\"Order\": {\"OrderId\": 123456,\"OrderLines\": [{\"SkuId\": 357159,\"Quantity\": 12.5},{\"SkuId\": 484186,\"Quantity\": 10}]}}";
            var transformer = "[{ \"#loop($.Order.OrderLines)\": { \"OrderId\": \"#valueof($.Order.OrderId)\", \"SkuId\": \"#currentvalueatpath($.SkuId)\", \"Quantity\": \"#currentvalueatpath($.Quantity)\" } }, { \"#loop($.Order.OrderLines)\": { \"OrderId\": \"#valueof($.Order.OrderId)\", \"SkuId\": \"#currentvalueatpath($.SkuId)\", \"Quantity\": \"#currentvalueatpath($.Quantity)\" } }]";
            var context = new JUSTContext
            {
                EvaluationMode = EvaluationMode.Strict | EvaluationMode.JoinArrays
            };
            ...
            Assert.AreEqual("[{\"OrderId\":123456,\"SkuId\":357159,\"Quantity\":12.5},{\"OrderId\":123456,\"SkuId\":484186,\"Quantity\":10},{\"OrderId\":123456,\"SkuId\":357159,\"Quantity\":12.5},{\"OrderId\":123456,\"SkuId\":484186,\"Quantity\":10}]", result);
        }
